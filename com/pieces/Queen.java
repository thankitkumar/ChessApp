...
public class Queen extends Piece {
    ...
    public Queen(int x, int y, boolean is_white, Board board)
    ...
    public boolean legalMove(int destination_x, int destination_y)
    {
        ...
        // queen can  move in straight and diagonally line ,if want to move anywhere let them
        if(this.getX() != destination_x && this.getY() != destination_y && this.getX() == destination_x && this.getY() == destination_y){ // condition for can move diagonally and straight
            return true;
        }
